...
const addressService = __importStar(require("../handlers/addressHandler"));
const getAddressByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const address = yield addressService.getAddressByUserId(parseInt(req.params.userID));
    if (address) {
        res.json(address);
    }
    else {
...
const createAddress = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const address = yield addressService.createAddress(street, city, userId);
...
const updateAddress = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const address = yield addressService.updateAddress(userId, street, city);
    res.json(address);
});
