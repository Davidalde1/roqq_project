...
const postService = __importStar(require("../handlers/postHandler"));
const getPostsByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const posts = yield postService.getPostsByUserId(parseInt(req.query.userId));
    res.json(posts);
});
exports.getPostsByUserId = getPostsByUserId;
const createPost = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { title, body, userId } = req.body;
    const post = yield postService.createPost(title, body, userId);
