...
const userService = __importStar(require("../handlers/userHandler"));
const getUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const pageNumber = parseInt(req.query.pageNumber) || 0;
    const pageSize = parseInt(req.query.pageSize) || 10;
    const users = yield userService.getUsers(pageNumber, pageSize);
    res.json(users);
});
...
const getUsersCount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const count = yield userService.getUsersCount();
    res.json({ count });
});
